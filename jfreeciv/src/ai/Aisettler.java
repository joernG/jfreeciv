...
//public static final int RESULT_IS_ENOUGH = 250;
//
//public static final int FERRY_TECH_WANT = 500;
//
//public static final int GROWTH_PRIORITY = 15;
//
...
//**************************************************************************/
//void cityresult_fill(player pplayer,
//                     ai_data ai,
//                     cityresult result)
//{
...
//  boolean handicap = ai_handicap(pplayer, H_MAP);
//
...
//**************************************************************************/
//static boolean food_starvation(cityresult result)
//{
...
//**************************************************************************/
//static boolean shield_starvation(cityresult result)
//{
...
//**************************************************************************/
//static int defense_bonus(cityresult result, ai_data ai)
//{
...
//**************************************************************************/
//static void city_desirability(player pplayer, ai_data ai,
...
//**************************************************************************/
//static boolean settler_map_iterate(pf_parameter parameter,
//				unit punit,
//				cityresult best,
//				player pplayer, 
//				int boat_cost)
...
//  pf_map map;
//  boolean found = false; /* The return value */
//
...
//  () settler_map_iterate(&parameter, punit, best, pplayer, 0);
//
//  if (best.result > RESULT_IS_ENOUGH) {
//    return;
//  }
