...
public class Autoattack{
	//TODO, tbd
	/*
	 * autoattack by: Sebastian Fischmeister <sfischme@nexus.lzk.tuwien.ac.at> and
	 * David Pfitzner <dwp@mso.anu.edu.au>
	 * 
	 * ToDo:
	 *  - if have movement and enough hp remaining, should consider attacking
	 * multiple times if multiple targets (hard, because you have to calculate
	 * warmap for each choice . lots of cpu !!!)
	 *  - create gui-client for diplomacy for players (in work by other persons)
	 * 
	 */
...
//		unit_list targets;
		...
		/*
		 * if a 'F_ONEATTACK' unit, range is larger, because they are not going to
		 * return this turn anyways
		 */
...
//						 * location, before allowing an auto-attack. Without this, units attack into
//						 * locations they cannot see, and maybe submarines are made erroneously
//						 * visible too.
//						 * 
//						 * Note, cheating AI may attack units it cannot see unless it has H_TARGETS
//						 * handicap, but currently AI never uses auto-attack.
//						 */
...
//
//						/*
//						 * Without this check, missiles are made useless for auto-attack as they get
//						 * triggered by fighters and bombers and end up being wasted when they
//						 * cannot engage.
//						 */
...
//					}
	 ...
	 * ...
	 ******************************************************************************/
	static void auto_attack_with_unit(player pplayer, city pcity,
			unit punit)
	{
		int id = punit.id;
		unit enemy;
...
//		city_list_iterate_end;
		...
		/*
		 * Now handle one-attack units which attacked the previous turn. These go
		 * home this turn, and don't auto-attack again until the next turn. This
		 * could be done better, but this is a start and should stop bombers from
		 * running out of fuel --dwp. (Normally units with ai.control do not have
		 * goto done automatically.)
		 */
