...
//      "help <command-name>\n"
//      "help <option-name>"),
//   N"Show help about server commands and server options.",
...
//   "list players\n"
//   "list connections",
//   N"Show a list of players or connections.",
...
//   "quit",
//   N"Quit the game and shutdown the server.", null
//  },
//  {"cut",	ALLOW_CTRL, ALLOW_CTRL,
//   /* TRANS: translate text between <> only */
//   N"cut <connection-name>",
//   N"Cut a client's connection to server.",
...
//   N"debug [ player <player> | city <x> <y> | units <x> <y> | unit <id> ]",
//   N"Turn on or off AI debugging of given entity.",
...
//   N"set <option-name> <value>",
//   N"Set server option.", null
//  },
//  {"team",	ALLOW_CTRL, ALLOW_INFO,
//   N"team <player> [team]",
//   N"Change, add or remove a player's team affiliation.",
...
//   N"rulesetdir <directory>",
//   N"Choose new ruleset directory or modpack.",
...
//   /* TRANS: translate text between <> only */
//   N"metainfo <meta-line>",
//   N"Set metaserver info line.", null
//  },
//  {"metatopic", ALLOW_CTRL, ALLOW_INFO,
//   /* TRANS: translate text between <> only */
//   N"metatopic <meta-line>",
//   N"Set metaserver topic line.", null
//  },
//  {"metapatches", ALLOW_HACK, ALLOW_HACK,
//   /* TRANS: translate text between <> only */
//   N"metapatch <meta-line>",
//   N"Set metaserver patches line.", null
//  },
//  {"metaconnection",	ALLOW_HACK, ALLOW_HACK,
//   "metaconnection u|up\n"
//   "metaconnection d|down\n"
//   "metaconnection ?",
//   N"Control metaserver connection.",
...
//   /* TRANS: translate text between <> only */
//   N"metaserver <address>",
//   N"Set address (URL) for metaserver to report to.", null
//  },
//  {"aitoggle",	ALLOW_CTRL, ALLOW_INFO,
//   /* TRANS: translate text between <> only */
//   N"aitoggle <player-name>",
//   N"Toggle AI status of player.", null
//  },
//  {"take",    ALLOW_INFO, ALLOW_INFO,
//   /* TRANS: translate text between [] and <> only */
//   N"take [connection-name] <player-name>",
//   N"Take over a player's place in the game.",
...
//   /* TRANS: translate text between [] only */
//   N"observe [connection-name] [player-name]",
//   N"Observe a player or the whole game.",
//   N_("Only the console and connections with cmdlevel 'hack' can force "
...
//   /* TRANS: translate text between <> only */
//   N"detach <connection-name>",
//   N"detach from a player.",
//   N_("Only the console and connections with cmdlevel 'hack' can force "
//      "other connections to detach from a player.")
//  },
//  {"create",	ALLOW_CTRL, ALLOW_INFO,
//   /* TRANS: translate text between <> only */
//   N"create <player-name>",
//   N"Create an AI player with a given name.",
...
//   N_("away\n"
//      "away"),
//   N"Set yourself in away mode. The AI will watch your back.",
//   N"The AI will govern your nation but do minimal changes.",
//  },
//  {"novice",	ALLOW_CTRL, ALLOW_INFO,
//   /* TRANS: translate text between <> only */
//   N_("novice\n"
//      "novice <player-name>"),
//   N"Set one or all AI players to 'novice'.",
...
//   N_("easy\n"
//      "easy <player-name>"),
//   N"Set one or all AI players to 'easy'.",
...
//   N_("normal\n"
//      "normal <player-name>"),
//   N"Set one or all AI players to 'normal'.",
...
//   N_("hard\n"
//      "hard <player-name>"),
//   N"Set one or all AI players to 'hard'.",
...
//   N"Set one or all AI players to 'experimental'.",
...
//   N"Query or set command access level access.",
...
//   "firstlevel",
//   N"Grab the 'first come' command access level.",
...
//   /* TRANS: translate text between <> only */
//   N"timeoutincrease <turn> <turninc> <value> <valuemult>", 
...
//   /* TRANS: translate text between <> only */
//   N"endgame <player1 player2 player3 ...>",
//   N"End the game.  If players are listed, these win the game.",
...
//   /* TRANS: translate text between <> only */
//   N"remove <player-name>",
//   N"Fully remove player from game.",
...
//   /* TRANS: translate text between <> only */
//   N"read <file-name>",
//   N"Process server commands from file.", null
//  },
//  {"write",	ALLOW_HACK, ALLOW_HACK,
//   /* TRANS: translate text between <> only */
//   N"write <file-name>",
//   N"Write current settings as server commands to file.", null
//  },
//  {"rfcstyle",	ALLOW_HACK, ALLOW_HACK,
//   "rfcstyle",
//   N"Switch server output between 'RFC-style' and normal style.", null
//  },
//  {"serverid",	ALLOW_INFO, ALLOW_INFO,
//   "serverid",
//   N"Simply returns the id of the server.",
//  }
//};
//
}