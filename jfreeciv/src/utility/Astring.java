...
//  in astr.n_alloc.
//***********************************************************************/
//void astr_minsize(astring astr, size_t n)
//{
//  int n1;
//  boolean was_null = (astr.n == 0);
//  
//  assert(astr != null);
//  
//  astr.n = n;
...
//****************************************************************************/
//static void vadd(astring astr, final String format, va_list ap)
//{
//  size_t new_len;
//  char buf[1024];
//
...
//  astr_minsize(astr, 1);
//
//  new_len = strlen(astr.str) + buf.length() + 1;
//
...
//  Add the text to the string.
//****************************************************************************/
//void astr_add(astring astr, final String format)
//{
//  va_list args;
//
