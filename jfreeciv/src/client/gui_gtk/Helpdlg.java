...
//public static final int TECH_TREE_EXPANDED_DEPTH = 2;
//
///*
// * Globals.
// */
...
//  }
//  d.tech = tech;
//  d.turns_to_tech = num_unknown_techs_for_goal(Game.game.player_ptr, tech);
...
//
//  help_tree_expand = gtk_button_new_with_label("Expand All");
//  help_tree_collapse = gtk_button_new_with_label("Collapse All");
//  help_tree_reset = gtk_button_new_with_label("Reset Tree");
//  help_tree_expand_unknown = gtk_button_new_with_label("Expand Unknown");
...
//    } else {
//      gtk_set_label(help_wlabel[5], "(Never)");
//    }
//
///*    create_tech_tree(help_improvement_tree, 0, imp.tech_req, 3);*/
//  }
...
//      gtk_set_label(help_ulabel[4][1], "(Never)");
//    } else {
...
//      gtk_set_label(help_ulabel[4][4], "None");
//    } else {
