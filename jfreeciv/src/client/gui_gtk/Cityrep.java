...
//
//static void create_city_report_config_dialog();
...
//					boolean change_prod,
//					boolean append_improvements,
//					boolean append_units,
//					boolean append_wonders,
//					TestCityFunc test_func,
//					boolean needs_a_selected_city)
//{
...
//    /* Add all buildings */
//    append_impr_or_unit_to_menu_sub(submenu, "No Buildings Available",
...
//  if (append_units) {
//    /* Add all units */
//    append_impr_or_unit_to_menu_sub(submenu, "No Units Available",
...
//
//    /* Add all wonders */
//    append_impr_or_unit_to_menu_sub(submenu, "No Wonders Available",
...
//
//    for (i = 0; i < GTK_CLIST(city_list).rows; i++) {
//      city pcity = gtk_clist_get_row_data(GTK_CLIST(city_list), i);
...
// "custom" preset.
//*****************************************************************/
//static void append_cma_to_menu(GtkWidget * menu, boolean change_cma)
//{
//  int i;
//  struct cm_parameter parameter;
//  GtkWidget *w;
...
//  menu = gtk_menu_new();
//  
//  append_impr_or_unit_to_menu(menu, "Improvements", true, true, false,
//			      false, city_can_build_impr_or_unit, true);
//
//  append_impr_or_unit_to_menu(menu, "Units", true, false, true, false,
//                              city_can_build_impr_or_unit, true);
//
//  append_impr_or_unit_to_menu(menu, "Wonders", true, false, false, true,
//                              city_can_build_impr_or_unit, true);
//
//  item = gtk_menu_item_new_with_label("CMA");
//  gtk_menu_append(GTK_MENU(menu), item);
...
//  }
//
//  item = gtk_menu_item_new_with_label("Change All...");
//  gtk_menu_append(GTK_MENU(menu), item);
...
//
//  gtk_window_set_title(GTK_WINDOW(city_dialog_shell),"Cities");
//
...
//
//  city_select_command	= gtk_accelbutton_new("_Select...", accel);
//  gtk_box_pack_start( GTK_BOX( GTK_DIALOG(city_dialog_shell).action_area ),
...
//		     null);
//
//  item=gtk_menu_item_new_with_label( "Same Island" );
//  gtk_menu_append(GTK_MENU(menu),item);  
//  gtk_signal_connect(GTK_OBJECT(item),"activate",
...
//  gtk_menu_append(GTK_MENU(menu),gtk_menu_item_new ());  
//
//  append_impr_or_unit_to_menu(menu, "Supported Units", false, false, 
//                              true, false, city_unit_supported, false);
//
//  append_impr_or_unit_to_menu(menu, "Units Present", false, false, 
//                              true, false, city_unit_present, false);
//
//  append_impr_or_unit_to_menu(menu, "Improvements in City", false, true, 
//                              false, true, city_building_present, false);
//
//  append_impr_or_unit_to_menu(menu, "Available Improvements", false, true,
//			      false, false, city_can_build_impr_or_unit,
//			      false);
//
//  append_impr_or_unit_to_menu(menu, "Available Units", false, false,
//			      true, false, city_can_build_impr_or_unit,
//			      false);
//
//  append_impr_or_unit_to_menu(menu, "Available Wonders", false, false,
...
//static void city_change_all_dialog_callback(GtkWidget *w, gpointer data)
//{
//  final String cmd = (final String)data;
//
//  if (cmd) {
...
//  gint row;
//  city pcity;
//  static final String title_[2][1] = { {N"From:"},
//				      {N"To:"}
//  };
...
//  gtk_window_set_title (GTK_WINDOW(config_shell), "Configure Cities Report");
...
//  
//  for(i=1, spec=city_report_specs+i; i<NUM_CREPORT_COLS; i++, spec++) {
//    spec.show = (boolean) GTK_TOGGLE_BUTTON(config_toggle[i]).active;
//  }
