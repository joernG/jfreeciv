...
//public static final int SPECLIST_TYPE = struct; cma_dialog
//#include "speclist.h"
//
...
//static void cma_preset_add_callback_yes(final String input, gpointer data);
...
//**************************************************************************/
//cma_dialog create_cma_dialog(city pcity, GtkAccelGroup *accel)
//{
//  cma_dialog pdialog;
//  struct cm_parameter param;
//  GtkWidget *frame, *page, *hbox, *label, *table;
//  GtkWidget *vbox, *scrolledwindow, *hscale;
//  static final String preset_title_[] = { N"Presets" };
...
//  }
//
//  frame = gtk_frame_new("Citizen Management Agent");
...
//
//  pdialog.add_preset_command = gtk_button_new_with_label("Add preset");
...
//
//  pdialog.del_preset_command = gtk_button_new_with_label("Delete preset");
...
//  gtk_box_pack_start(GTK_BOX(vbox), hbox, false, false, 0);
//
//  pdialog.change_command = gtk_accelbutton_new("Apply onc_e", accel);
...
//
//  pdialog.perm_command = gtk_accelbutton_new("Control c_ity", accel);
...
//		     pdialog);
//
//  pdialog.release_command = gtk_accelbutton_new("_Release city", accel);
...
//    }
//  } else {
//    static final String info_message_[4] = {
//      N"For information on:",
//      N"CMA and presets",
//      N"including sample presets,",
//      N"see README.cma."
//    };
