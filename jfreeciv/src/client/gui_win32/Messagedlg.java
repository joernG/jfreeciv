...
//  fcwin_box hbox;
//  fcwin_box vbox;
//  fcwin_box table_vboxes[2*(NUM_MW+1)];
//  int i,j;
...
//  fcwin_box_add_static(table_vboxes[1],"Out:",0,SS_CENTER,true,true,0);
//  fcwin_box_add_static(table_vboxes[2],"Mes:",0,SS_CENTER,true,true,0);
//  fcwin_box_add_static(table_vboxes[3],"Pop:",0,SS_CENTER,true,true,0);
//  fcwin_box_add_static(table_vboxes[4]," ",0,SS_LEFT,true,true,0);
//  fcwin_box_add_static(table_vboxes[5],"Out:",0,SS_CENTER,true,true,0);
//  fcwin_box_add_static(table_vboxes[6],"Mes:",0,SS_CENTER,true,true,0);
//  fcwin_box_add_static(table_vboxes[7],"Pop:",0,SS_CENTER,true,true,0);
...
//}
//
//public static final int OPTIONS_PER_PAGE = 40;
///**************************************************************************
//... 
//**************************************************************************/
