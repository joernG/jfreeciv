...
// 
//  for (; d < 10; d++) {
//    Sprite sprite = sprites.tax_gold;
//
//    gtk_image_set_from_pixmap(GTK_IMAGE(econ_label[d]),
//			      sprite.pixmap, sprite.mask);
//  }
...
//...
//**************************************************************************/
//static boolean map_center = true;
//static boolean map_configure = false;
//
...
//...
//**************************************************************************/
//void put_unit_gpixmap(unit punit, GtkPixcomm *p)
//{
...
//**************************************************************************/
//void put_unit_gpixmap_city_overlays(unit punit, GtkPixcomm *p)
//{
//  struct canvas store;
// 
...
//**************************************************************************/
//static void fog_sprite(Sprite sprite)
//{
//  int x, y;
//  GdkPixbuf *fogged;
//  guchar *pixel;
