...
//
//static ADVANCED_DLG pWants = null;
//static ADVANCED_DLG pOffers = null;
//static ADVANCED_DLG pClauses_Dlg = null;
//
//static void popdown_diplomacy_dialog();
//static void popdown_sdip_dialog();
//
///**************************************************************************
...
///* ----------------------------------------------------------------------- */
//
//static int remove_clause_callback(GUI pWidget)
//{
...
//{
//  SDL_String16 *pStr;
//  GUI pBuf, *pWindow = pClauses_Dlg.pEndWidgetList;
//  char cBuf[64];
//  struct Clause Cl;
//  boolean redraw_all, scroll = pClauses_Dlg.pActiveWidgetList == null;
...
///* ================================================================= */
//
//static int cancel_meeting_callback(GUI pWidget)
//{
...
//}
//
//static int accept_treaty_callback(GUI pWidget)
//{
...
///* ------------------------------------------------------------------------ */
//
//static int pact_callback(GUI pWidget)
//{
//  int clause_type;
//  
...
//}
//
//static int vision_callback(GUI pWidget)
//{
//  dsend_packet_diplomacy_create_clause_req(&aconnection,
//					   pClauses_Dlg.pEndWidgetList.
//					   data.cont.id1,
...
//}
//
//static int maps_callback(GUI pWidget)
//{
//  int clause_type;
//  
//  switch(MAX_ID - pWidget.ID) {
...
//}
//
//static int techs_callback(GUI pWidget)
//{
//  dsend_packet_diplomacy_create_clause_req(&aconnection,
//					   pClauses_Dlg.pEndWidgetList.
//					   data.cont.id1,
...
//}
//
//static int gold_callback(GUI pWidget)
//{
//  int amount;
//  
...
//
//
//static int cities_callback(GUI pWidget)
//{
//  dsend_packet_diplomacy_create_clause_req(&aconnection,
//					   pClauses_Dlg.pEndWidgetList.
//					   data.cont.id1,
...
//
//
//static int dipomatic_window_callback(GUI pWindow)
//{
//  return -1;
//}
//
//static ADVANCED_DLG  popup_diplomatic_objects(player pPlayer0,
//  				player pPlayer1,
//  				GUI pMainWindow, boolean L_R)
//{
//  ADVANCED_DLG pDlg = MALLOC(sizeof(struct ADVANCED_DLG));
...
//    pBuf = create_iconlabel_from_chars(null, pWindow.dst,
//		"Maps", 12, WF_DRAW_THEME_TRANSPARENT);
//    pBuf.string16.fgcol = color_t;
//    width = MAX(width, pBuf.size.w);
//    height = MAX(height, pBuf.size.h);
//    add_to_gui_list(ID_LABEL, pBuf);
...
//	     
//	     pBuf = create_iconlabel_from_chars(null, pWindow.dst,
//		"Advances", 12, WF_DRAW_THEME_TRANSPARENT);
//             pBuf.string16.fgcol = color_t;
//	     width = MAX(width, pBuf.size.w);
//	     height = MAX(height, pBuf.size.h);
//             add_to_gui_list(ID_LABEL, pBuf);
...
//      
//      pBuf = create_iconlabel_from_chars(null, pWindow.dst,
//		"Cities", 12, WF_DRAW_THEME_TRANSPARENT);
//      pBuf.string16.fgcol = color_t;
...
//	
//    pBuf.string16 = create_str16_from_char("Cancel meeting", 12);
//    
...
//	
//    pBuf.string16 = create_str16_from_char("Accept treaty", 12);
//    
...
///* ================================================================= */
//static SMALL_DLG pSDip_Dlg = null;
//
//static void popdown_sdip_dialog()
//{
//  if (pSDip_Dlg) {
...
//}
//
//static int sdip_window_callback(GUI pWindow)
//{
//  return std_move_window_group_callback(pSDip_Dlg.pBeginWidgetList,
//								pWindow);
//}
//
//static int withdraw_vision_dlg_callback(GUI pWidget)
//{
//  popdown_sdip_dialog();
//
...
//}
//
//static int cancel_pact_dlg_callback(GUI pWidget)
//{
//  popdown_sdip_dialog();
//
//  dsend_packet_diplomacy_cancel_pact(&aconnection,
...
//}
//
//static int call_meeting_dlg_callback(GUI pWidget)
//{
//  popdown_sdip_dialog();
//  
...
//
//
//static int cancel_sdip_dlg_callback(GUI pWidget)
//{
//  popdown_sdip_dialog();
//  flush_dirty();
//  return -1;
//}
//
//static void popup_war_dialog(player pPlayer)
//{
//  int hh, ww = 0;
//  char cBuf[128];
//  GUI pBuf = null, *pWindow;
...
//
//    pBuf = create_themeicon_button_from_chars(pTheme.CANCEL_Icon,
//			    pWindow.dst, "Send him back", 12, 0);
//
//    pBuf.action = cancel_sdip_dlg_callback;
//    set_wstate(pBuf, FC_WS_NORMAL);
//    pBuf.string16.fgcol = color;
