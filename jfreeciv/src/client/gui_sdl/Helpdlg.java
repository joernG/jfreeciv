...
//
//
//static ADVANCED_DLG pHelpDlg = null;
//  
//struct TECHS_BUTTONS {
//  GUI pTargets[6], *pSub_Targets[6];
//  GUI pReq[2], *pSub_Req[4];
//  GUI pDock;
//  boolean show_tree;
//  boolean show_full_tree;
//};
//
...
//
//static int change_tech_callback(GUI pWidget);
//  
///**************************************************************************
...
//}
//
//static int help_dlg_window_callback(GUI pWindow)
//{
//  return -1;
//}
//
//static int exit_help_dlg_callback(GUI pWidget)
//{
//  popdown_help_dialog();
//  flush_dirty();
//  return -1;
...
///* =============================================== */
//
//static int change_gov_callback(GUI pWidget)
//{
...
//
//
//static int change_impr_callback(GUI pWidget)
//{
//  popup_impr_info(MAX_ID - pWidget.ID);
//  return -1;
//}
//
//static void redraw_impr_info_dlg()
//{
//  GUI pWindow = pHelpDlg.pEndWidgetList;
//  UNITS_BUTTONS pStore = (UNITS_BUTTONS )pWindow.data.ptr;
//  SDL_Rect dst;
...
//  GUI pDock;
//  GUI pWindow;
//  UNITS_BUTTONS pStore;
//  SDL_String16 *pStr;
//  SDL_Surface *pSurf;
//  int w, h, start_x, start_y;
//  boolean created, text = false;
//  int width = 0;
//  impr_type pImpr_type;
//  char buffer[64000];
//  
...
//    
//    pStr = create_str16_from_char("Help : Improvement", 12);
...
//    pStore = (UNITS_BUTTONS )pWindow.data.ptr;
//    pDock = pStore.pDock;
//    
...
//  }
//  pBuf = create_iconlabel_from_chars(null,
//		    pWindow.dst, N"Requirement:", 12, 0);
//  pBuf.ID = ID_LABEL;
//  DownAdd(pBuf, pDock);
//  pDock = pBuf;
//  
...
//  
//  pBuf = create_iconlabel_from_chars(null,
//		    pWindow.dst, N"Obsolete by:", 12, 0);
//  pBuf.ID = ID_LABEL;
//  DownAdd(pBuf, pDock);
//  pDock = pBuf;
//  
...
//
///* ============================================ */
//static int change_unit_callback(GUI pWidget)
//{
//  popup_unit_info(MAX_ID - pWidget.ID);
//  return -1;
//}
//
//static void redraw_unit_info_dlg()
//{
//  GUI pWindow = pHelpDlg.pEndWidgetList;
//  UNITS_BUTTONS pStore = (UNITS_BUTTONS )pWindow.data.ptr;
//  SDL_Rect dst;
...
//    pStore = MALLOC(sizeof(struct UNITS_BUTTONS));
//    
//    pStr = create_str16_from_char("Help : Units", 12);
//    pStr.style |= TTF_STYLE_BOLD;
//
//    pWindow = create_window(null, pStr, 400, 400, WF_FREE_DATA);
//    pWindow.action = help_dlg_window_callback;
...
//    pBuf.ID = ID_LABEL;  
//  } else {
//    unit_type utype = get_unit_type(pUnit.obsoleted_by);
//    pBuf = create_iconlabel_from_chars(null, pWindow.dst,
...
//}
//
//static int show_help_callback(GUI pWidget)
//{
//  TECHS_BUTTONS pStore = (TECHS_BUTTONS )pHelpDlg.pEndWidgetList.data.ptr;
...
//}
//
//static void redraw_tech_info_dlg()
//{
//  GUI pWindow = pHelpDlg.pEndWidgetList;
//  TECHS_BUTTONS pStore = (TECHS_BUTTONS )pWindow.data.ptr;
...
//  
//  /* -------------------------- */
//  pStr = create_str16_from_char("Allows", 14);
//  pStr.style |= TTF_STYLE_BOLD;
//  
...
//      
//    copy_chars_to_string16(pStr, "( witch ");
//    pText0 = create_text_surf_from_str16(pStr);
//    
...
//}
//
//static GUI  create_tech_info(Tech_Type_id tech, int width, GUI pWindow, TECHS_BUTTONS pStore)
//{
//  GUI pBuf;
//  GUI pLast, *pBudynki;
//  GUI pDock = pStore.pDock;
...
//    unit_type pUnit = get_unit_type(un);
...
//
//
//static void redraw_tech_tree_dlg()
//{
//  GUI pWindow = pHelpDlg.pEndWidgetList;
//  GUI pSub0, *pSub1;
//  TECHS_BUTTONS pStore = (TECHS_BUTTONS )pWindow.data.ptr;
//  GUI pTech = pStore.pDock.prev;
...
//}
//
//static int toggle_full_tree_mode_in_help_dlg_callback(GUI pWidget)
//{
//  TECHS_BUTTONS pStore = (TECHS_BUTTONS )pHelpDlg.pEndWidgetList.data.ptr;
...
//
//
//static GUI  create_tech_tree(Tech_Type_id tech, int width, GUI pWindow, TECHS_BUTTONS pStore)
//{
...
//    pStore.show_full_tree = false;
//    
//    pStr = create_str16_from_char("Help : Advances Tree", 12);
//    pStr.style |= TTF_STYLE_BOLD;
//
//    pWindow = create_window(null, pStr, 400, 400, WF_FREE_DATA);
//    pWindow.data.ptr = (void *)pStore;
...
//    width = (pHelpDlg.pScroll ? pHelpDlg.pScroll.pUp_Left_Button.size.w: 0);
//    pWindow = pHelpDlg.pEndWidgetList;
//    pStore = (TECHS_BUTTONS )pWindow.data.ptr;
//    pDock = pStore.pDock;
//    
//    /* del. all usless widget */
//    if (pDock  != pHelpDlg.pBeginWidgetList)
