...
//} *pCma = null;
//
//static void set_cma_hscrollbars();
//
///* =================================================================== */
//
//static int cma_dlg_callback(GUI pWindow)
//{
//  return -1;
//}
//
//static int exit_cma_dialog_callback(GUI pWidget)
//{
...
//}
//
//static int min_horiz_cma_callback(GUI pWidget)
//{
...
//}
//
//static int factor_horiz_cma_callback(GUI pWidget)
//{
//  struct hmove pMotion;
//    
//  pMotion.pScrollBar = pWidget;
...
//}
//
//static int toggle_cma_celebrating_callback(GUI pWidget)
//{
...
///* ============================================================= */
//
//static int save_cma_window_callback(GUI pWindow)
//{
//  return -1;
//}
//
//static int ok_save_cma_callback(GUI pWidget)
//{
//  if(pWidget && pCma && pCma.pAdv) {
//    GUI pEdit = (GUI )pWidget.data.ptr;
...
//      FREE(name);
//    } else {
//      cmafec_preset_add("new preset", &pCma.edited_cm_parm);
//    }
//        
...
///* -------------------------------------------------------------------- */
//static int cancel_SLD_cma_callback(GUI pWidget)
//{
//  if(pCma && pCma.pAdv) {
...
//}
//
//static int save_cma_callback(GUI pWidget)
//{
//  int hh, ww = 0;
//  GUI pBuf, *pWindow;
//  SDL_String16 *pStr;
...
//  pStr = create_str16_from_char("Name new preset", 12);
...
//  /* ============================================================= */
//  /* label */
//  pStr = create_str16_from_char("What should we name the preset?", 10);
...
//  		create_str16_from_char("new preset", 12), 100,
...
///* ================================================== */
//
//static int LD_cma_callback(GUI pWidget)
//{
//  boolean load = pWidget.data.ptr != null;
...
//
//
//static void popup_load_del_presets_dialog(boolean load, GUI pButton)
//{
//  int hh, ww, count, i;
//  GUI pBuf, *pWindow;
//  SDL_String16 *pStr;
...
//  pCma.pAdv = MALLOC(sizeof(struct ADVANCED_DLG));
//      
//  pStr = create_str16_from_char("Presets", 12);
//  pStr.style |= TTF_STYLE_BOLD;
//
...
//}
//
//static int load_cma_callback(GUI pWidget)
//{
//  popup_load_del_presets_dialog(true, pWidget);
//  return -1;
//}
//
//static int del_cma_callback(GUI pWidget)
//{
...
//**************************************************************************/
//static int run_cma_callback(GUI pWidget)
//{
//  cma_put_city_under_agent(pCma.pCity, &pCma.edited_cm_parm);
//  update_city_cma_dialog();
//  return -1;
...
//**************************************************************************/
//static int run_cma_once_callback(GUI pWidget)
//{
...
//}
//
//static int stop_cma_callback(GUI pWidget)
//{
//  cma_release_city(pCma.pCity);
//  update_city_cma_dialog();
//  return -1;
...
//
///* ===================================================================== */
//void update_city_cma_dialog()
//{
//  int count, step, i;
//  GUI pBuf = pCma.pDlg.pEndWidgetList; /* pWindow */
//  SDL_Surface *pText;
//  SDL_String16 *pStr;
//  SDL_Rect dst;
//  SDL_Color color = {255, 255, 255, 136};
//  boolean cma_presets_exist = cmafec_preset_num() > 0;
//  boolean client_under_control = can_client_issue_orders();
//  boolean controlled = cma_is_city_under_agent(pCma.pCity, null);
//  struct cm_result result;
//    
...
//}
//
//void popup_city_cma_dialog(city pCity)
//{
//  GUI pWindow, *pBuf;
...
//  text_w = 0;
//  
//  copy_chars_to_string16(pStr, "Minimal Surplus");
//  pMinimal = create_text_surf_from_str16(pStr);
//    
//  copy_chars_to_string16(pStr, "Factor");
...
//  }
//  
//  copy_chars_to_string16(pStr, "Celebrate");
...
//  pBuf.string16 = create_str16_from_char("Save settings as...", 10);
//  
...
//  pBuf.string16 = create_str16_from_char("Load settings", 10);
//  
//  add_to_gui_list(ID_ICON, pBuf);
//  
//  /* del settings */
...
//  pBuf.string16 = create_str16_from_char("Delete settings", 10);
//  
//  add_to_gui_list(ID_ICON, pBuf);
//    
//  /* run cma */
...
//  pBuf.string16 = create_str16_from_char("Control city", 10);
//  
//  add_to_gui_list(ID_ICON, pBuf);
//  
//  /* run cma onece */
...
//  pBuf.string16 = create_str16_from_char("Apply once", 10);
//  
//  add_to_gui_list(ID_ICON, pBuf);
//  
//  /* del settings */
...
//  pBuf.string16 = create_str16_from_char("Release city", 10);
//  
//  add_to_gui_list(ID_ICON, pBuf);
//  
//  /* -------------------------------- */
