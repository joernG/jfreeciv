...
//  GUI pEndWidgetList;/* window */
//    
//  ADVANCED_DLG pTargets;
//  ADVANCED_DLG pWork;
//  ADVANCED_DLG pGlobal;
//    
//  city pCity;
//  worklist pOrginal_WorkList;
//  worklist pCopy_WorkList;
//  
//  /* shortcuts  */
//  GUI pDock;
//  GUI pWorkList_Counter;
//  
//  GUI pProduction_Name;
//  GUI pProduction_Progres;
//    
//  int stock;
//  int currently_building;
//  boolean is_building_unit;
//  
//} *pEditor = null;
//
//
//static int worklist_editor_item_callback(GUI pWidget);
//static SDL_Surface * get_progress_icon(int stock, int cost, int *progress);
//static final String get_production_name(city pCity,
//					  int id, boolean is_unit, int *cost);
//static void refresh_worklist_count_label();
//static void refresh_production_label(int stock);
//
///* =========================================================== */
//
///* Worklist Editor Window Callback */
//static int window_worklist_editor_callback(GUI pWidget)
//{
//  return -1;
//}
//
///* Popdwon Worklist Editor */
//static int popdown_worklist_editor_callback(GUI pWidget)
//{
//  if(pEditor) {
...
// */
//static int ok_worklist_editor_callback(GUI pWidget)
//{
//  int i, j;
//  city pCity = pEditor.pCity;
//  boolean same_prod = true;
//  
...
// */
//static int rename_worklist_editor_callback(GUI pWidget)
//{
...
// */
//static void add_target_to_worklist(GUI pTarget)
//{
//  boolean is_unit = false;
//  int i, target = MAX_ID - pTarget.ID;
//  GUI pBuf = null, *pDock = null;
...
// */
//static void change_production(int target, boolean is_unit)
//{
//    
...
// */
//static void add_target_to_production(GUI pTarget)
//{
//  boolean is_unit = false;
//  int target, dummy;
//  assert(pTarget != null);
...
//static void get_target_help_data(GUI pTarget)
//{
//  boolean is_unit = false;
//  int target;
//  assert(pTarget != null);
...
// */
//static int worklist_editor_targets_callback(GUI pWidget)
//{
...
// */
//static void remove_item_from_worklist(GUI pItem)
//{
//  if(pItem.data.ptr) {
...
// */
//static void swap_item_down_from_worklist(GUI pItem)
//{
//  int id;
//  Uint16 *pText, ID;
...
// * and first element of worklist is build).
// */
//static void swap_item_up_from_worklist(GUI pItem)
//{
//  int id;
...
// */
//static int global_worklist_callback(GUI pWidget)
//{
//  switch(Main.event.button.button) {
//    case SDL_BUTTON_LEFT:
...
//  char cBuf[64];
//  SDL_Rect area;
//  final String name = get_production_name(pEditor.pCity,
//    				pEditor.currently_building,
...
// */
//void popup_worklist_editor(city pCity, worklist pWorkList)
//{
//  int count = 0, turns;
//  int i, w, h, widget_w = 0, widget_h = 0;
//  SDL_String16 *pStr = null;
//  GUI pBuf = null, *pWindow, *pLast;
...
//  char *state = null;
//  boolean advanced_tech = pCity == null;
//  boolean can_build, can_eventually_build;
//  
//  if(pEditor) {
//    return;
//  }
...
//    /* count == cost */
//    /* turns == progress */
//    final String name = get_production_name(pCity,
