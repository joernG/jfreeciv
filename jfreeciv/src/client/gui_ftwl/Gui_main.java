...
//
//final String client_string = "gui-fs";
//
...
//    boolean dump = !sw_get_dump_screen();
//
...
//      util.freelog(Log.LOG_NORMAL, "enabling screen dumper");
...
//    util.freelog(Log.LOG_ERROR, "The resolution '%s' doesn't parse", resolution);
//  }
//  free(resolution);
//  
//  sw_init();
