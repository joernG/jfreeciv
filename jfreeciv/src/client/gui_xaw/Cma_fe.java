...
//
//
//static void update_cma_preset_list();
...
//                                    XtPointer position_val);
//static void update_stat_labels(boolean is_valid);
...
//**************************************************************************/
//void show_cma_dialog(city pcity, Widget citydlg)
//{
...
//         XtNlabel, parameter.require_happy ? "Yes" : "No",
...
//                      "What should we name the new preset?", 
//                      "new preset",
...
//  XtVaSetValues(w, XtNlabel, celebrate ? "Yes" : "No", null);
//
