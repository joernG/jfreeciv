...
//}
//
//final String get_packet_name(enum packet_type type)
//{
//  switch(type) {
//
//  case PACKET_PROCESSING_STARTED:
...
//      int i;
//    
//      for (i = 0; i < specialist_type.getSize(); i++) {
//        {
//      int readin;
//    
//      dio_get_uint8(&din, &readin);
...
//
//    {
//      differ = (specialist_type.getSize() != specialist_type.getSize());
//      if(!differ) {
//        int i;
//        for (i = 0; i < specialist_type.getSize(); i++) {
...
//
//    {
//      differ = (City_H.CITY_MAP_SIZE * City_H.CITY_MAP_SIZE != City_H.CITY_MAP_SIZE * City_H.CITY_MAP_SIZE);
//      if(!differ) {
//        int i;
//        for (i = 0; i < City_H.CITY_MAP_SIZE * City_H.CITY_MAP_SIZE; i++) {
...
//
//  real_packet->city_id = city_id;
//  worklist.copy_worklist(&real_packet->worklist, worklist);
//  
...
//}
//
//int dsend_packet_city_change_specialist(Connection pc, int city_id, specialist_type from, specialist_type to)
//{
