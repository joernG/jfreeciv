...
//  con_write(Erfc_status.C_COMMENT, "You can learn a lot about Freeciv at %s",
//	    WEBSITE_URL);
//
//  if (showhelp) {
//    fc_fprintf(stderr,
...
//#endif
//    fc_fprintf(stderr, "  -f, --file FILE\tLoad saved game FILE\n");
//    fc_fprintf(stderr,
