...
//public static final int MAX_CITY_DESC_WIDTH = 128;
//public static final int MAX_CITY_DESC_HEIGHT = 32;
//
///*
// * Set to true if the backing store is more recent than the version
// * drawn into overview.window.
// */
//static boolean overview_dirty = false;
//
//static void base_canvas_to_map_pos(int *map_x, int *map_y,
//				   int canvas_x, int canvas_y);
//static void center_tile_overviewcanvas(tile ptile);
//static void get_mapview_corners(int x[4], int y[4]);
//static void redraw_overview();
//static void dirty_overview();
//static void flush_dirty_overview();
//
///**************************************************************************
// Refreshes a single tile on the map canvas.
//**************************************************************************/
//void refresh_tile_mapcanvas(tile ptile, boolean write_to_screen)
//{
...
//(x2,y2).
//**************************************************************************/
//enum color_std get_grid_color(tile tile1, enum direction8 dir)
//{
//  enum city_tile_type city_tile_type1, city_tile_type2;
//  city dummy_pcity;
//  boolean pos1_is_in_city_radius;
...
//  to be even numbers.
//**************************************************************************/
//boolean tile_to_canvas_pos(int *canvas_x, int *canvas_y, tile ptile)
//{
...
//**************************************************************************/
//tile canvas_pos_to_tile(int canvas_x, int canvas_y)
//{
//  int map_x, map_y;
//
...
//**************************************************************************/
//tile canvas_pos_to_nearest_tile(int canvas_x, int canvas_y)
//{
//  int map_x, map_y;
//
//  base_canvas_to_map_pos(&map_x, &map_y, canvas_x, canvas_y);
...
//    canvas target = mapview_canvas.tmp_store;
//
...
//**************************************************************************/
//tile get_center_tile_mapcanvas()
//{
...
//**************************************************************************/
//void center_tile_mapcanvas(tile ptile)
//{
//  int gui_x, gui_y;
//
...
//  map canvas.
//**************************************************************************/
//boolean tile_visible_mapcanvas(tile ptile)
//{
...
//**************************************************************************/
//boolean tile_visible_and_not_on_border_mapcanvas(tile ptile)
//{
//  int canvas_x, canvas_y;
...
//**************************************************************************/
//static void put_drawn_sprites(canvas pcanvas,
//			      int canvas_x, int canvas_y,
//			      int count, drawn_sprite pdrawn,
//			      boolean fog)
//{
//  int i;
//
...
//**************************************************************************/
//void put_unit(unit punit,
//	      canvas pcanvas, int canvas_x, int canvas_y)
//{
...
//****************************************************************************/
//void put_city_tile_output(city pcity, int city_x, int city_y,
//			  canvas pcanvas,
//			  int canvas_x, int canvas_y)
//{
...
//  sprites (limiting the number of combinations).
//****************************************************************************/
//void put_unit_city_overlays(unit punit,
//			    canvas pcanvas,
//			    int canvas_x, int canvas_y)
//{
...
//****************************************************************************/
//void toggle_city_color(city pcity)
//{
//  int canvas_x, canvas_y;
...
//  city_colors array; above.
//****************************************************************************/
//void toggle_unit_color(unit punit)
//{
//  int canvas_x, canvas_y;
//  int width = get_citydlg_canvas_width();
//  int height = get_citydlg_canvas_height();
...
//****************************************************************************/
//static boolean get_tile_boundaries(enum direction8 dir,
//				int inset, int width,
...
//****************************************************************************/
//void put_red_frame_tile(canvas pcanvas,
//			int canvas_x, int canvas_y)
//{
//  enum direction8 dir;
//
...
//****************************************************************************/
//void put_nuke_mushroom_pixmaps(tile ptile)
//{
//  int canvas_x, canvas_y;
//  Sprite mysprite = sprites.explode.nuke;
//  int width, height;
//
...
//**************************************************************************/
//static void tile_draw_borders(canvas pcanvas,
//			      tile ptile,
//			      int canvas_x, int canvas_y)
//{
...
//  view.
//**************************************************************************/
//void put_one_tile(canvas pcanvas, tile ptile,
...
//**************************************************************************/
//static void put_tile(tile ptile)
//{
//  int canvas_x, canvas_y;
//
//  if (tile_to_canvas_pos(&canvas_x, &canvas_y, ptile)) {
...
//****************************************************************************/
//static void tile_draw_map_grid(canvas pcanvas,
//			       tile ptile,
//			       int canvas_x, int canvas_y)
//{
//  enum direction8 dir;
...
//****************************************************************************/
//static void tile_draw_coastline(canvas pcanvas,
//				tile ptile,
//				int canvas_x, int canvas_y)
//{
...
//   position.
//****************************************************************************/
//static void tile_draw_selection(canvas pcanvas,
//				tile ptile,
//				int canvas_x, int canvas_y, boolean citymode)
//{
...
//****************************************************************************/
//void tile_draw_grid(canvas pcanvas, tile ptile,
//		    int canvas_x, int canvas_y, boolean citymode)
//{
...
//**************************************************************************/
//void put_one_tile_iso(canvas pcanvas, tile ptile,
//		      int canvas_x, int canvas_y, boolean citymode)
//{
...
//				ptile.city, citymode);
//  boolean fog = (tile_get_known(ptile) == TILE_KNOWN_FOGGED && draw_fog_of_war
//	      && fogstyle == 0);
//
...
//  real (we have to draw unreal tiles too).
//**************************************************************************/
//static void put_tile_iso(tile ptile)
//{
//  int canvas_x, canvas_y;
//
//  if (tile_to_canvas_pos(&canvas_x, &canvas_y, ptile)) {
...
//**************************************************************************/
//void update_city_description(city pcity)
//{
//  int canvas_x, canvas_y;
//
...
//****************************************************************************/
//boolean show_unit_orders(unit punit)
//{
...
//****************************************************************************/
//void draw_segment(tile src_tile, enum direction8 dir)
//{
...
//**************************************************************************/
//void undraw_segment(tile src_tile, enum direction8 dir)
//{
//  int canvas_x, canvas_y, canvas_dx, canvas_dy;
//
...
//**************************************************************************/
//void move_unit_map_canvas(unit punit,
//			  tile src_tile, int dx, int dy)
//{
//  static timer anim_timer = null;
//  tile dest_tile;
//  int dest_x, dest_y;
...
//**************************************************************************/
//city find_city_or_settler_near_tile(tile ptile,
//					    unit *punit)
//{
//  city pcity = ptile.worked, *closest_city;
//  unit closest_settler = null, *best_settler = null;
//
//  if (punit) {
//    *punit = null;
//  }
...
//**************************************************************************/
//city find_city_near_tile(tile ptile)
//{
...
//  into the buffer.
//**************************************************************************/
//void get_city_mapview_production(city pcity,
...
//**************************************************************************/
//void get_city_mapview_name_and_growth(city pcity,
//				      char *name_buffer,
...
//static void redraw_overview()
//{
//  canvas dest = get_overview_window();
//
...
//**************************************************************************/
//void overview_update_tile(tile ptile)
//{
...
//**************************************************************************/
//boolean map_canvas_resized(int width, int height)
//{
...
//  boolean tile_size_changed, size_changed, redrawn = false;
//
//  /* Resized */
//
