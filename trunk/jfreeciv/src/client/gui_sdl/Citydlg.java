...
//
///* ============================================================= */
//public static final int SCALLED_TILE_WIDTH = 48;
//public static final int SCALLED_TILE_HEIGHT = 24;
//
//public static final int NUM_UNITS_SHOWN = 3;
//
...
//  GUI pBeginCityWidgetList;
//  GUI pEndCityWidgetList;
//
//  /* Imprvm. vscrollbar */
//  ADVANCED_DLG pImprv;
//  
...
//    
//  /* Menu imprv. dlg. */
//  GUI pBeginCityMenuWidgetList;
//  GUI pEndCityMenuWidgetList;
//
//  /* shortcuts */
//  GUI pAdd_Point;
//  GUI pBuy_Button;
...
//} *pCityDlg = null;
//
//static SMALL_DLG pHurry_Prod_Dlg = null;
//
//static void popdown_hurry_production_dialog();
//static void disable_city_dlg_widgets();
//static void redraw_city_dialog(city pCity);
//static void rebuild_imprm_list(city pCity);
//static void rebuild_citydlg_title_str(GUI pWindow, city pCity);
//
///* ======================================================================= */
//
///**************************************************************************
...
//**************************************************************************/
//static void del_city_menu_dlg(boolean enable)
//{
...
//**************************************************************************/
//static int city_dlg_callback(GUI pWindow)
//{  
//  if (!cma_is_city_under_agent(pCityDlg.pCity, null)
//     && City.city_owner(pCityDlg.pCity) == Game.game.player_ptr) {
//       
//    /* check elvis area */
//    if (pCityDlg.specs[0]
...
//**************************************************************************/
//static int cancel_units_orders_city_dlg_callback(GUI pButton)
//{
...
//**************************************************************************/
//static int activate_units_orders_city_dlg_callback(GUI pButton)
//{
//  unit pUnit = pButton.data.unit;
//
...
//**************************************************************************/
//static int activate_and_exit_units_orders_city_dlg_callback(GUI pButton)
//{
//  unit pUnit = pButton.data.unit;
//
//  if(pUnit) {
...
//  redraw_city_dialog(pCityDlg.pCity);
//**************************************************************************/
//static int sentry_units_orders_city_dlg_callback(GUI pButton)
//{
//  unit pUnit = pButton.data.unit;
//
//  del_city_menu_dlg(true);
...
//  redraw_city_dialog(pCityDlg.pCity);
//**************************************************************************/
//static int fortify_units_orders_city_dlg_callback(GUI pButton)
//{
//  unit pUnit = pButton.data.unit;
//
//  del_city_menu_dlg(true);
...
//  redraw_city_dialog(pCityDlg.pCity);
//**************************************************************************/
//static int disband_units_orders_city_dlg_callback(GUI pButton)
//{
//  unit pUnit = pButton.data.unit;
//
//  free_city_units_lists();
...
//  redraw_city_dialog(pCityDlg.pCity);
//**************************************************************************/
//static int homecity_units_orders_city_dlg_callback(GUI pButton)
//{
//  unit pUnit = pButton.data.unit;
//
//  del_city_menu_dlg(true);
...
//  redraw_city_dialog(pCityDlg.pCity);
//**************************************************************************/
//static int upgrade_units_orders_city_dlg_callback(GUI pButton)
//{
//  unit pUnit = pButton.data.unit;
//    
//  lock_buffer(pButton.dst);
...
//**************************************************************************/
//static int units_orders_dlg_callback(GUI pButton)
//{
//  return -1;
//}
//
...
//**************************************************************************/
//static int units_orders_city_dlg_callback(GUI pButton)
//{
//  SDL_String16 *pStr;
//  char cBuf[80];
//  GUI pBuf, *pWindow = pCityDlg.pEndCityWidgetList;
//  unit pUnit;
//  unit_type pUType;
//  Uint16 ww, i, hh;
//
...
//		  "Activate unit, close dialog",  12, 0);
//  i++;
//  ww = MAX(ww, pBuf.size.w);
//  hh = MAX(hh, pBuf.size.h);
//  clear_wflag(pBuf, WF_DRAW_FRAME_AROUND_WIDGET);
...
//**************************************************************************/
//static SDL_Surface *create_unit_surface(unit pUnit, boolean support)
//{
//  int i, step;
//  SDL_Rect dest;
//  SDL_Surface *pSurf =
...
//**************************************************************************/
//static void create_present_supported_units_widget_list(unit_list pList)
//{
//  int i;
//  GUI pBuf = null;
//  GUI pEnd = null;
//  GUI pWindow = pCityDlg.pEndCityWidgetList;
//  city pHome_City;
//  unit_type pUType;
//  SDL_Surface *pSurf;
//  SDL_String16 *pStr;
...
//		pUnit.hp, pUType.hp,
//		pHome_City ? pHome_City.name : "None");
//    
//    if (pCityDlg.state == SUPPORTED_UNITS_PAGE) {
//      int pcity_near_dist;
//      city pNear_City = get_nearest_city(pUnit, &pcity_near_dist);
//
//      sz_strlcat(cBuf, "\n");
...
//    }
//  
//    if (pCityDlg.pCity.owner == Game.game.player_idx) {    
//      set_wstate(pBuf, FC_WS_NORMAL);
//    }
//    
...
//**************************************************************************/
//static int army_city_dlg_callback(GUI pButton)
//{
//  
//  if (pCityDlg.state != ARMY_PAGE) {
//    free_city_units_lists();
...
//**************************************************************************/
//static int supported_unit_city_dlg_callback(GUI pButton)
//{
//  if (pCityDlg.state != SUPPORTED_UNITS_PAGE) {
//    free_city_units_lists();
...
//**************************************************************************/
//static int info_city_dlg_callback(GUI pButton)
//{
...
//**************************************************************************/
//static int happy_city_dlg_callback(GUI pButton)
//{
...
//**************************************************************************/
//static int misc_panel_city_dlg_callback(GUI pWidget)
//{
...
//  ...
//**************************************************************************/
//static void create_city_options_widget_list(city pCity)
//{
//  GUI pBuf, *pWindow = pCityDlg.pEndCityWidgetList;
//  SDL_Surface *pSurf;
//  SDL_String16 *pStr;
...
//**************************************************************************/
//static int options_city_dlg_callback(GUI pButton)
//{
//
...
//  ...
//**************************************************************************/
//static int cma_city_dlg_callback(GUI pButton)
//{
//  disable_city_dlg_widgets();
...
//  Exit city dialog.
//**************************************************************************/
//static int exit_city_dlg_callback(GUI pButton)
//{
...
//**************************************************************************/
//static int cancel_buy_prod_city_dlg_callback(GUI pButton)
//{
...
//  buy productions.
//**************************************************************************/
//static int ok_buy_prod_city_dlg_callback(GUI pButton)
//{
...
//**************************************************************************/
//static int buy_prod_city_dlg_callback(GUI pButton)
//{
//  redraw_icon(pButton);
//  flush_rect(pButton.size);
//  disable_city_dlg_widgets();
...
//**************************************************************************/
//static int hurry_production_window_callback(GUI pWindow)
//{
...
//  popup buy productions dlg.
//**************************************************************************/
//void popup_hurry_production_dialog(city pCity, SDL_Surface *pDest)
//{
//
//  int value, hh, ww = 0;
//  final String name;
...
//  pStr = create_str16_from_char("Buy It?", 12);
//  pStr.style |= TTF_STYLE_BOLD;
...
//
//  if (!pCity.did_buy && Game.game.player_ptr.economic.gold >= value) {
...
//**************************************************************************/
//static int change_prod_dlg_callback(GUI pButton)
//{
//  redraw_icon(pButton);
//  flush_rect(pButton.size);
//
...
//**************************************************************************/
//static int sell_imprvm_dlg_cancel_callback(GUI pCancel_Button)
//{
...
//**************************************************************************/
//static int sell_imprvm_dlg_ok_callback(GUI pOK_Button)
//{
//  GUI pTmp = (GUI )pOK_Button.data.ptr;
//
...
//**************************************************************************/
//static int sell_imprvm_dlg_callback(GUI pImpr)
//{
...
//  		pTheme.Small_OK_Icon, pImpr.dst, "Sell", 10,  0);
//
...
//		      pCityDlg.pImprv.pEndActiveWidgetList, FC_WS_DISABLED);
//      } else {
//        GUI pTmpWidget = pCityDlg.pImprv.pEndActiveWidgetList;
//
//        while (true) {
...
//**************************************************************************/
//static boolean sdl_city_to_canvas_pos(int *canvas_x, int *canvas_y, int city_x, int city_y)
//{
//  if (is_isometric) {
//    /*
...
//(either isometric or overhead).  It should be in cityview.c instead.
//**************************************************************************/
//static boolean sdl_canvas_to_city_pos(int *city_x, int *city_y, int canvas_x, int canvas_y)
//{
...
//**************************************************************************/
//static boolean get_citymap_cr(Sint16 map_x, Sint16 map_y, int *pCol, int *pRow)
//{
...
//#endif
//
//SDL_Surface * get_scaled_city_map(city pCity)
//{
...
//**************************************************************************/
//static int resource_map_city_dlg_callback(GUI pMap)
//{
//  int col, row;
//#ifndef NO_ISO
...
//**************************************************************************/
//static int next_prev_city_dlg_callback(GUI pButton)
//{
//  int i, dir, non_open_size, size =
//      Game.game.player_ptr.cities.foo_list_size();
//  city *array;
//
//  assert(size >= 1);
//  assert(pCityDlg.pCity.owner == Game.game.player_idx);
//
//  if (size == 1) {
//    return -1;
//  }
...
//  }
//
//  array = MALLOC(size * sizeof(city ));
//
//  non_open_size = 0;
//  for (i = 0; i < size; i++) {
//    array[non_open_size++] = city_list_get(&Game.game.player_ptr.cities, i);
//  }
//
...
//  Rename city name: 
//**************************************************************************/
//static int new_name_city_dlg_callback(GUI pEdit)
//{
...
//  207 = max panel width
//**************************************************************************/
//static void redraw_misc_city_dialog(GUI pCityWindow,
//				    city pCity)
//{
//  char cBuf[60];
//  SDL_String16 *pStr;
...
//  207 = max panel width
//**************************************************************************/
//static void redraw_supported_units_city_dialog(GUI pCityWindow,
//					       city pCity)
//{
//  char cBuf[60];
//  SDL_String16 *pStr;
...
//  207 = max panel width
//**************************************************************************/
//static void redraw_army_city_dialog(GUI pCityWindow,
//				    city pCity)
//{
//  char cBuf[60];
//  SDL_String16 *pStr;
...
//  207 = max panel width
//**************************************************************************/
//static void redraw_info_city_dialog(GUI pCityWindow,
//				    city pCity)
//{
//  char cBuf[30];
//  city pTradeCity = null;
//  int step, i, xx;
//  SDL_String16 *pStr = null;
...
//  
//  /* is_worker_here(city , int, int) - is function pointer */
...
//    /* with granary */
//    /* stocks label */
//    copy_chars_to_string16(pStr, "Stock");
//    pBuf = create_text_surf_from_str16(pStr);
//
...
//
//    /* granary label */
//    copy_chars_to_string16(pStr, "Granary");
//    pBuf = create_text_surf_from_str16(pStr);
//
...
//
//    if (!pCityDlg.pCity.did_sell
//        && !pImpr.is_wonder && (pOwner == Game.game.player_ptr)) {
//      set_wstate(pBuf, FC_WS_NORMAL);
//    }
//
...
//  ...
//**************************************************************************/
//static void rebuild_citydlg_title_str(GUI pWindow,
//				      city pCity)
//{
//  char cBuf[512];
//
...
//    mystrlcat(cBuf, " - under CMA control.", sizeof(cBuf));
//  }
//  
...
//			   WF_DRAW_THEME_TRANSPARENT));
//  pBuf.string16 = create_str16_from_char("Cancel", 12);
...
//			  (WF_WIDGET_HAS_INFO_LABEL |
//			   WF_DRAW_THEME_TRANSPARENT));
//  pBuf.string16 = create_str16_from_char("Information panel", 12);
...
//			  (WF_WIDGET_HAS_INFO_LABEL |
//			   WF_DRAW_THEME_TRANSPARENT));
//  pBuf.string16 = create_str16_from_char("Happiness panel", 12);
...
//			  (WF_WIDGET_HAS_INFO_LABEL |
//			   WF_DRAW_THEME_TRANSPARENT));
//  pBuf.string16 = create_str16_from_char("Garrison panel", 12);
...
//			  (WF_WIDGET_HAS_INFO_LABEL |
//			   WF_DRAW_THEME_TRANSPARENT));
//  pBuf.string16 = create_str16_from_char("Maintenance panel", 12);
...
//  if (!cma_is_city_under_agent(pCity, null) && (pOwner == Game.game.player_ptr)) {
//    set_wstate(pBuf, FC_WS_NORMAL);
//  }
//  pBuf.size.x =
...
//			  (WF_WIDGET_HAS_INFO_LABEL |
//			   WF_DRAW_THEME_TRANSPARENT));
//    pBuf.string16 = create_str16_from_char("Options panel", 12);
...
//			  (WF_WIDGET_HAS_INFO_LABEL |
//			   WF_DRAW_THEME_TRANSPARENT));
//    pBuf.string16 = create_str16_from_char("Change Production", 12);
...
//			  (WF_WIDGET_HAS_INFO_LABEL |
//			   WF_DRAW_THEME_TRANSPARENT));
//    pBuf.string16 = create_str16_from_char("Hurry production", 12);
...
//			  (WF_WIDGET_HAS_INFO_LABEL |
//			   WF_DRAW_THEME_TRANSPARENT));
//    pBuf.string16 = create_str16_from_char("Citizen Management Agent", 12);
...
//			   WF_DRAW_THEME_TRANSPARENT));
//
//    pBuf.string16 = create_str16_from_char("Prev city", 12);
...
//			  (WF_WIDGET_HAS_INFO_LABEL |
//			   WF_DRAW_THEME_TRANSPARENT));
//    pBuf.string16 = create_str16_from_char("Next city", 12);
//    pBuf.action = next_prev_city_dlg_callback;
