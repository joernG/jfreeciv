...
//#include "inteldlg.h"
//
//static ADVANCED_DLG pIntel_Dlg = null;
//
//static int intel_window_dlg_callback(GUI pWindow)
//{
//  return std_move_window_group_callback(pIntel_Dlg.pBeginWidgetList, pWindow);
//}
//
//static int tech_callback(GUI pWidget)
//{
//  /* get tech help - PORT ME */
//  return -1;
//}
//
//static int spaceship_callback(GUI pWidget)
//{
...
//
//
//static int exit_intel_dlg_callback(GUI pWidget)
//{
//  popdown_intel_dialog();
//  flush_dirty();
//  return -1;
...
//{
//  GUI pWindow = null, *pBuf = null, *pLast;
...
//  
//  pStr = create_str16_from_char("Foreign Intelligence Report" , 12);
...
//    (!pCapital) ? "(Unknown)" : pCapital.name, pPlayer.economic.gold,
