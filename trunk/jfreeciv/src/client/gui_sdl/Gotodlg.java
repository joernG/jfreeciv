...
//#include "gotodlg.h"
//
//static ADVANCED_DLG pGotoDlg = null;
//static Uint32 all_players = 0;
//static boolean GOTO = true;
//
//static void update_goto_dialog();
//
//static int goto_dialog_window_callback(GUI pWindow)
//{
//  return std_move_window_group_callback(pGotoDlg.pBeginWidgetList, pWindow);
//}
//
//static int exit_goto_dialog_callback(GUI pWidget)
//{
...
//}
//
//static int toggle_goto_nations_cities_dialog_callback(GUI pWidget)
//{
...
//**************************************************************************/
//static void popup_goto_airlift_dialog()
//{
//  GUI pBuf, *pWindow;
//  SDL_String16 *pStr;
...
//    
//  pStr = create_str16_from_char("Select destination", 12);
//  pStr.style |= TTF_STYLE_BOLD;
//  
