...
//
//struct EDIT {
//  UniChar pBeginTextChain;
//  UniChar pEndTextChain;
//  UniChar pInputChain;
//  SDL_Surface *pBg;
//  GUI pWidget;
//  int ChainLen;
...
//
//static GUI pBeginMainWidgetList;
///* static GUI pEndMainWidgetList; */
//
...
//static int redraw_iconlabel(GUI pLabel);
//SDL_Surface * get_buffer_layer(boolean transparent);
//
///**************************************************************************
...
//**************************************************************************/
//GUI MainWidgetListScaner(int x, int y)
//{
...
//  ...
//**************************************************************************/
//GUI MainWidgetListKeyScaner(SDL_keysym Key)
//{
...
//**************************************************************************/
//Uint16 widget_pressed_action(GUI  pWidget)
//{
//  Uint16 ID = 0;
//
//  if (!pWidget) {
...
//  case WT_EDIT:
//  {
//    boolean ret, loop = ((get_wflags(pWidget) & WF_EDIT_LOOP) == WF_EDIT_LOOP);
...
//**************************************************************************/
//void widget_sellected_action(GUI pWidget)
//{
...
//  ...
//**************************************************************************/
//void draw_widget_info_label()
//{
//  SDL_Surface *pText, *pBcgd;
//  SDL_Rect dest;
//  SDL_Color color;
//
//  GUI pWidget = pSellected_Widget;
//
//  if (!pWidget) {
//    return;
//  }
...
//  this Widgets.
//**************************************************************************/
//GUI get_widget_pointer_form_main_list(Uint16 ID)
//{
...
//**************************************************************************/
//void init_gui_list(Uint16 ID, GUI pGUI)
//{
...
//**************************************************************************/
//void add_to_gui_list(Uint16 ID, GUI pGUI)
//{
...
//**************************************************************************/
//void DownAdd(GUI pNew_Widget, GUI pAdd_Dock)
//{
...
//**************************************************************************/
//void del_widget_pointer_from_gui_list(GUI pGUI)
//{
//  if (!pGUI) {
//    return;
//  }
...
//  first.
//**************************************************************************/
//boolean is_this_widget_first_on_list(GUI pGUI)
//{
...
//**************************************************************************/
//void move_widget_to_front_of_gui_list(GUI pGUI)
//{
...
//**************************************************************************/
//void del_gui_list(GUI pGUI_List)
//{
//  while (pGUI_List) {
//    if (pGUI_List.next) {
//      pGUI_List = pGUI_List.next;
...
//**************************************************************************/
//void move_group_to_front_of_gui_list(GUI pBeginGroupWidgetList,
//				     GUI pEndGroupWidgetList)
//{
//  GUI pTmpWidget = pEndGroupWidgetList , *pPrev = null;
...
//  ...
//**************************************************************************/
//void del_group_of_widgets_from_gui_list(GUI pBeginGroupWidgetList,
//					GUI pEndGroupWidgetList)
//{
//  GUI pBufWidget = null;
//  GUI pTmpWidget = pEndGroupWidgetList;
//
...
//  ...
//**************************************************************************/
//void set_group_state(GUI pBeginGroupWidgetList,
//		     GUI pEndGroupWidgetList, enum WState state)
//{
//  GUI pTmpWidget = pEndGroupWidgetList;
//  while (pTmpWidget) {
...
//  ...
//**************************************************************************/
//void hide_group(GUI pBeginGroupWidgetList,
//		GUI pEndGroupWidgetList)
//{
//  GUI pTmpWidget = pEndGroupWidgetList;
//
...
//  ...
//**************************************************************************/
//void show_group(GUI pBeginGroupWidgetList,
//		GUI pEndGroupWidgetList)
//{
//  GUI pTmpWidget = pEndGroupWidgetList;
//
...
//**************************************************************************/
//void popdown_window_group_dialog(GUI pBeginGroupWidgetList,
//				 GUI pEndGroupWidgetList)
//{
//  if ((pBeginGroupWidgetList) && (pEndGroupWidgetList)) {
...
//**************************************************************************/
//boolean sellect_window_group_dialog(GUI pBeginWidgetList,
//							 GUI pWindow)
//{
...
//**************************************************************************/
//boolean move_window_group_dialog(GUI pBeginGroupWidgetList,
//			     GUI pEndGroupWidgetList)
//{
//  boolean ret = false;
...
//**************************************************************************/
//int std_move_window_group_callback(GUI pBeginWidgetList,
//							 GUI pWindow)
//{
...
//**************************************************************************/
//static GUI vertical_scroll_widget_list(GUI pActiveWidgetLIST,
//				      GUI pBeginWidgetLIST,
//				      GUI pEndWidgetLIST,
//				      int active, int step, int dir)
//{
//  GUI pBegin = pActiveWidgetLIST;
//  GUI pBuf = pActiveWidgetLIST;
//  GUI pTmp = null;  
...
//  ...
//**************************************************************************/
//static int get_step(ScrollBar pScroll)
//{
...
//  ...
//**************************************************************************/
//static int get_position(ADVANCED_DLG pDlg)
//{
//  GUI pBuf = pDlg.pActiveWidgetList;
...
//  ...
//**************************************************************************/
//static GUI down_scroll_widget_list(ScrollBar pVscroll,
//				    GUI pBeginActiveWidgetLIST,
//				    GUI pBeginWidgetLIST,
//				    GUI pEndWidgetLIST)
//{
//  struct UP_DOWN pDown;
//  GUI pBegin = pBeginActiveWidgetLIST;
...
//  ...
//**************************************************************************/
//static GUI up_scroll_widget_list(ScrollBar pVscroll,
//				  GUI pBeginActiveWidgetLIST,
//				  GUI pBeginWidgetLIST,
//				  GUI pEndWidgetLIST)
//{
...
//  FIXME
//**************************************************************************/
//static GUI vertic_scroll_widget_list(ScrollBar pVscroll,
//				      GUI pBeginActiveWidgetLIST,
//				      GUI pBeginWidgetLIST,
//				      GUI pEndWidgetLIST)
//{
...
//**************************************************************************/
//boolean add_widget_to_vertical_scroll_widget_list(ADVANCED_DLG pDlg,
//				      GUI pNew_Widget,
//				      GUI pAdd_Dock, boolean dir,
//					Sint16 start_x, Sint16 start_y)
//{
//  GUI pBuf = null;
//  GUI pEnd = null, *pOld_End = null;
//  int count = 0;
//  boolean last = false, seen = true;
//  
...
//**************************************************************************/
//boolean del_widget_from_vertical_scroll_widget_list(ADVANCED_DLG pDlg, 
//  						GUI pWidget)
//{
//  int count = 0;
//  GUI pBuf = pWidget;
...
//  ...
//**************************************************************************/
//static int std_up_advanced_dlg(GUI pWidget)
//{
//  ADVANCED_DLG pDlg = pWidget.private_data.adv_dlg;
//  GUI pBegin = up_scroll_widget_list(
//			pDlg.pScroll,
...
//  ...
//**************************************************************************/
//static int std_down_advanced_dlg(GUI pWidget)
//{
//  ADVANCED_DLG pDlg = pWidget.private_data.adv_dlg;
//  GUI pBegin = down_scroll_widget_list(
//			pDlg.pScroll,
//			pDlg.pActiveWidgetList,
//			pDlg.pBeginActiveWidgetList,
//			pDlg.pEndActiveWidgetList);
...
//**************************************************************************/
//static int std_vscroll_advanced_dlg(GUI pScrollBar)
//{
//  ADVANCED_DLG pDlg = pScrollBar.private_data.adv_dlg;
//  GUI pBegin = vertic_scroll_widget_list(
//			pDlg.pScroll,
//			pDlg.pActiveWidgetList,
//			pDlg.pBeginActiveWidgetList,
//			pDlg.pEndActiveWidgetList);
...
//  ...
//**************************************************************************/
//Uint32 create_vertical_scrollbar(ADVANCED_DLG pDlg,
//		  Uint8 step, Uint8 active,
//		  boolean create_scrollbar, boolean create_buttons)
//{
//  Uint16 count = 0;
//  GUI pBuf = null, *pWindow = null;
//    
//  assert(pDlg != null);
//  
...
//  ...
//**************************************************************************/
//void setup_vertical_scrollbar_area(ScrollBar pScroll,
//	Sint16 start_x, Sint16 start_y, Uint16 hight, boolean swap_start_x)
//{
//  boolean buttons_exist;
//  
//  assert(pScroll != null);
//  
...
//  ...
//**************************************************************************/
//void setup_vertical_scrollbar_default_callbacks(ScrollBar pScroll)
//{
//  assert(pScroll != null);
...
//  ...
//**************************************************************************/
//Uint32 create_horizontal_scrollbar(ADVANCED_DLG pDlg,
//		  Sint16 start_x, Sint16 start_y, Uint16 width, Uint16 active,
//		  boolean create_scrollbar, boolean create_buttons, boolean swap_start_y)
//{
//  Uint16 count = 0;
//  GUI pBuf = null, *pWindow = null;
//    
...
//**************************************************************************/
//void set_new_icon_theme(GUI pIcon_Widget, SDL_Surface * pNew_Theme)
//{
...
//**************************************************************************/
//GUI  create_themeicon(SDL_Surface *pIcon_theme, SDL_Surface *pDest,
//							  Uint32 flags)
//{
//  GUI pIcon_Widget = MALLOC(sizeof(struct GUI));
//
...
//  ...
//**************************************************************************/
//int draw_icon(GUI pIcon, Sint16 start_x, Sint16 start_y)
//{
...
//  ...
//**************************************************************************/
//int real_redraw_icon(GUI pIcon)
//{
...
//  set new theme and callculate new size.
//**************************************************************************/
//void set_new_icon2_theme(GUI pIcon_Widget, SDL_Surface *pNew_Theme,
//			  boolean free_old_theme)
//{
//  if ((pNew_Theme) && (pIcon_Widget)) {
//    if(free_old_theme) {
//      FREESURFACE(pIcon_Widget.theme);
...
//**************************************************************************/
//GUI  create_icon2(SDL_Surface *pIcon, SDL_Surface *pDest, Uint32 flags)
//{
//
//  GUI pIcon_Widget = MALLOC(sizeof(struct GUI));
//
...
//  ...
//**************************************************************************/
//int real_redraw_icon2(GUI pIcon)
//{
//  int ret;
//  SDL_Rect dest;
//  Uint32 state;
...
//**************************************************************************/
//GUI  create_icon_button(SDL_Surface *pIcon, SDL_Surface *pDest,
...
//  function return pointer to allocated Button Widget.
//**************************************************************************/
//GUI  create_themeicon_button(SDL_Surface *pIcon_theme,
//		SDL_Surface *pDest, SDL_String16 *pString16, Uint32 flags)
//{
//  SDL_Surface *pIcon = create_icon_from_theme(pIcon_theme, 1);
//  GUI pButton = create_icon_button(pIcon, pDest, pString16, flags);
//
...
//  Else return 0.
//**************************************************************************/
//int draw_tibutton(GUI pButton, Sint16 start_x, Sint16 start_y)
//{
...
//  Else return 0.
//**************************************************************************/
//int draw_ibutton(GUI pButton, Sint16 start_x, Sint16 start_y)
//{
//  pButton.size.x = start_x;
//  pButton.size.y = start_y;
...
//  Else return 0.
//**************************************************************************/
//int real_redraw_ibutton(GUI pIButton)
//{
...
//**************************************************************************/
//int real_redraw_tibutton(GUI pTIButton)
//{
//  int iRet = 0;
...
//  UniChar chr_tmp = null;
//
//  len = unipInText.length();
//
//  if (len == 0) {
//    return pOutChain;
//  }
...
//...
//**************************************************************************/
//static void redraw_edit_chain(EDIT pEdt)
//{
//  UniChar pInputChain_TMP;
...
//**************************************************************************/
//GUI  create_edit(SDL_Surface *pBackground, SDL_Surface *pDest,
//		SDL_String16 *pString16, Uint16 length, Uint32 flags)
//{
//  SDL_Rect buf = {0, 0, 0, 0};
//
//  GUI pEdit = MALLOC(sizeof(struct GUI));
//
...
//**************************************************************************/
//int draw_edit(GUI pEdit, Sint16 start_x, Sint16 start_y)
//{
...
//  be created.
//**************************************************************************/
//int redraw_edit(GUI pEdit_Widget)
//{
//  if (get_wstate(pEdit_Widget) & FC_WS_PRESSED) {
//    redraw_edit_chain((EDIT )pEdit_Widget.data.ptr);
//  } else {
//    int iRet = 0;
...
//}
//
//enum Edit_Return_Codes edit_field(GUI pEdit_Widget)
//{
//  struct EDIT pEdt;
//  struct UniChar ___last;
//  UniChar pInputChain_TMP = null;
...
//**************************************************************************/
//GUI  create_vertical(SDL_Surface *pVert_theme, SDL_Surface *pDest,
//  			Uint16 high, Uint32 flags)
//{
//  GUI pVer = MALLOC(sizeof(struct GUI));
//
...
//  ...
//**************************************************************************/
//int draw_vert(GUI pVert, Sint16 x, Sint16 y)
//{
//  pVert.size.x = x;
//  pVert.size.y = y;
...
//  function return pointer to allocated Widget.
//**************************************************************************/
//GUI  create_horizontal(SDL_Surface *pHoriz_theme, SDL_Surface *pDest,
//  		Uint16 width, Uint32 flags)
//{
//  GUI pHor = MALLOC(sizeof(struct GUI));
//
...
//  ...
//**************************************************************************/
//int draw_horiz(GUI pHoriz, Sint16 x, Sint16 y)
//{
//  pHoriz.size.x = x;
//  pHoriz.size.y = y;
...
//
//  "boolean transparent" parm deside what buffer format will be created.
...
//**************************************************************************/
//GUI  create_window(SDL_Surface *pDest, SDL_String16 *pTitle, 
//  			Uint16 w, Uint16 h, Uint32 flags)
//{
//  GUI pWindow = MALLOC(sizeof(struct GUI));
//
...
//**************************************************************************/
//static void make_copy_of_pixel_and_draw_frame_window(GUI pWindow,
...
//**************************************************************************/
//static void draw_frame_of_window_from_array(GUI pWindow,
...
//  ...
//**************************************************************************/
//boolean move_window(GUI pWindow)
//{
//  boolean ret;
//  struct MOVE pMove;
...
//  ...
//**************************************************************************/
//void refresh_widget_background(GUI pWidget)
//{
//  if (pWidget) {
//    if (pWidget.gfx && pWidget.gfx.w == pWidget.size.w &&
//      				pWidget.gfx.h == pWidget.size.h) {
//      boolean is_colorkey = (pWidget.dst.flags & SDL_SRCCOLORKEY) > 0;
...
//  ...
//**************************************************************************/
//void remake_label_size(GUI pLabel)
//{
...
//
//  if (pText) {
//    boolean without_box = ((get_wflags(pLabel) & WF_SELLECT_WITHOUT_BAR) == WF_SELLECT_WITHOUT_BAR);
//    boolean bold = true;
//    
//    if (without_box)
//    {
...
//**************************************************************************/
//GUI  create_themelabel(SDL_Surface *pIcon, SDL_Surface *pDest,
...
//**************************************************************************/
//GUI  create_iconlabel(SDL_Surface *pIcon, SDL_Surface *pDest,
...
//  ThemeLabel is String16 with Background ( pIcon ).
//**************************************************************************/
//GUI  create_themelabel2(SDL_Surface *pIcon, SDL_Surface *pDest,
//  		SDL_String16 *pText, Uint16 w, Uint16 h, Uint32 flags)
//{
//  GUI pLabel = null;
...
//}
//
//GUI  convert_iconlabel_to_themeiconlabel2(GUI pIconLabel)
//{
//  SDL_Rect start, area;
//  SDL_Color store, color = {0,0,255,96};
...
//  ...
//**************************************************************************/
//static int redraw_themelabel(GUI pLabel)
//{
//  int ret;
//  Sint16 x, y;
...
//  ...
//**************************************************************************/
//static inline int redraw_themelabel2(GUI pLabel)
//{
//    
...
//  ...
//**************************************************************************/
//int draw_label(GUI pLabel, Sint16 start_x, Sint16 start_y)
//{
...
//  ...
//**************************************************************************/
//GUI create_checkbox(SDL_Surface *pDest, boolean state, Uint32 flags)
//{
//  GUI pCBox = MALLOC(sizeof(struct GUI));
//  CHECKBOX pTmp = MALLOC(sizeof(struct CHECKBOX));
//    
//  if (state) {
...
//  ...
//**************************************************************************/
//GUI  create_textcheckbox(SDL_Surface *pDest, boolean state,
//		  SDL_String16 *pStr, Uint32 flags)
//{
//  GUI pCBox;
//  CHECKBOX pTmp;
...
//}
//
//int set_new_checkbox_theme(GUI pCBox ,
...
//}
//
//boolean get_checkbox_state(GUI pCBox)
//{
//  return pCBox.private_data.cbox.state;
//}
//
//int redraw_textcheckbox(GUI pCBox)
//{
//  int ret;
