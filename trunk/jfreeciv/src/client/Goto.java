...
//
//static void increment_drawn(tile src_tile, enum direction8 dir);
//static void decrement_drawn(tile src_tile, enum direction8 dir);
//static void reset_last_part();
//
//
///**************************************************************************
...
//***********************************************************************/
//static void update_last_part(tile ptile)
//{
...
//    pf_position a = &new_path.positions[i];
//
//    if (is_valid_dir(a.dir_to_next_pos)) {
...
//  } else {
//    part prev = &goto_map.parts[goto_map.num_parts - 2];
//
...
//***********************************************************************/
//static void fill_client_goto_parameter(unit punit,
//				       pf_parameter parameter)
//{
//  static int speed;
//
...
//  initial part.
//***********************************************************************/
//void enter_goto_state(unit punit)
//{
//  assert(!is_active);
//
...
//  cleared.
//****************************************************************************/
//void request_orders_cleared(unit punit)
//{
...
//**************************************************************************/
//static void send_path_orders(unit punit, pf_path path,
//			     boolean repeat, boolean vigilant,
...
//**************************************************************************/
//void send_goto_path(unit punit, pf_path path,
//		    enum unit_activity final_activity)
//{
...
//  to the server.
//**************************************************************************/
//void send_patrol_route(unit punit)
//{
//  int i;
//  pf_path path = null, *return_path;
//  struct pf_parameter parameter = goto_map.template;
//  pf_map map;
//
//  assert(is_active);
...
//  to the server.
//**************************************************************************/
//void send_connect_route(unit punit, enum unit_activity activity)
//{
//  pf_path path = null;
//  int i;
//  struct packet_unit_orders p;
...
//**************************************************************************/
//void send_goto_route(unit punit)
//{
//  pf_path path = null;
//  int i;
//
...
//  when in doubt.
//***********************************************************************/
//static unsigned char *get_drawn_char(tile ptile, enum direction8 dir)
//{
//  tile tile1;
//
...
//****************************************************************************/
//boolean is_drawn_line(tile ptile, int dir)
//{
...
//***************************************************************************/
//pf_path path_to_nearest_allied_city(unit punit)
//{
//  city pcity = null;
