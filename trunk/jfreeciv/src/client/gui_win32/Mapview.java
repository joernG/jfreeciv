...
//
//static Sprite indicator_sprite[3];
//
...
//**************************************************************************/
//void
//update_unit_info_label(unit punit)
//{
...
//}
//
//public static final int MAX_DIRTY_RECTS = 20;
//static int num_dirty_rects = 0;
//static struct {
//  int x, y, w, h;
//} dirty_rects[MAX_DIRTY_RECTS];
//boolean is_flush_queued = false;
//
///**************************************************************************
...
//
//    DrawText(hdc, buffer, buffer.length(), &name_rect, DT_CALCRECT);
//
//    if (buffer2[0] != '\0') {
//      DrawText(hdc, buffer2, buffer2.length(), &growth_rect, DT_CALCRECT);
...
//    DrawText(hdc, buffer, buffer.length(), &rc, DT_NOCLIP);
//    
//    rc.left++;
//    rc.top--;
//    rc.right++;
...
//
//      SetTextColor(hdc, RGB(0, 0, 0));
//      DrawText(hdc, buffer2, buffer2.length(), &rc, DT_NOCLIP);
//
//      rc.left++;
//      rc.top--;
//      rc.right++;
...
//    rc.bottom += rc.top; 
//    SetTextColor(hdc, RGB(0, 0, 0));
//    DrawText(hdc, buffer, buffer.length(), &rc, DT_NOCLIP | DT_CENTER);
//    rc.left++;
//    rc.top--;
//    rc.right++;
//    rc.bottom--;
...
//**************************************************************************/
//void
//put_cross_overlay_tile(tile ptile)
//{
//  HDC hdc;
...
//	rc.top+=h;
//	rc.bottom+=h;
//	DrawText(hdc, s, s.length(), &rc, DT_CENTER);
//	rc.left++;
//	rc.right++;
//	rc.top--;
//	rc.bottom--;
