...
//{
//  input_dialog_data idata;
//  idata=(input_dialog_data )fcwin_get_user_data(button);
...
//				   LPARAM lParam)
//{
//  input_dialog_data id;
//  id=(input_dialog_data )fcwin_get_user_data(hWnd);
//  switch(message)
//    {
//    case WM_CREATE:
//      break;
...
//  fcwin_box_add_button(hbox,"OK",ID_INPUT_OK,0,true,true,5);
//  fcwin_box_add_button(hbox,"Cancel",ID_INPUT_CANCEL,0,true,true,5);
//  vbox=fcwin_vbox_new(dlg,false);
//  fcwin_box_add_static(vbox,text,0,SS_LEFT,false,false,5);
//  fcwin_box_add_edit(vbox,postinputtext,MAX(30,postinputtext.length()),
//		     ID_INPUT_TEXT,
