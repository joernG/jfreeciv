...
//{
//  int delta = 10;
//  int lux_end = Game.game.player_ptr.economic.luxury;
//  int sci_end = lux_end + Game.game.player_ptr.economic.science;
//#if 0 /* Unneeded. */
//  int tax_end = 100; 
//#endif
//  int luxury = Game.game.player_ptr.economic.luxury;
//  int science = Game.game.player_ptr.economic.science;
//  int tax = Game.game.player_ptr.economic.tax;
//  
//  i *= 10;
//  if (i < lux_end) {
//    luxury -= delta;
