...
//#include "muistuff.h"
//
//VOID myWritePixelArray8(RastPort rp, unsigned long xstart,
...
//};
//
//static VOID Overview_HandleMouse(Object * o, Overview_Data data, LONG x, LONG y)
//{
...
//static LONG Overview_GetMapPen(Overview_Data data, LONG x, LONG y)
//{
...
//}
//
//static VOID Overview_FillBuffer(Overview_Data  data)
//{
...
//}
//
//static VOID Overview_DrawRect(Object *o, Overview_Data data)
//{
//  RastPort rp = _rp(o);
//
...
//}
//
//static ULONG Overview_New(IClass cl, Object * o, opSet msg)
//{
//  if ((o = (Object *) DoSuperMethodA(cl, o, (Msg) msg)))
//  {
//    Overview_Data data = (Overview_Data ) INST_DATA(cl, o);
...
//}
//
//static ULONG Overview_Dispose(IClass  cl, Object * o, Msg msg)
//{
//  return DoSuperMethodA(cl, o, msg);
//}
//
//static ULONG Overview_Set(IClass  cl, Object * o, opSet  msg)
//{
//  Overview_Data data = (Overview_Data ) INST_DATA(cl, o);
//  TagItem tl = msg.ops_AttrList;
//  TagItem ti;
...
//}
//
//static ULONG Overview_Get(IClass  cl, Object * o, opGet  msg)
//{
//  Overview_Data data = (Overview_Data ) INST_DATA(cl, o);
...
//}
//
//static ULONG Overview_Setup(IClass  cl, Object * o, Msg msg)
//{
//  Overview_Data data = (Overview_Data ) INST_DATA(cl, o);
//
...
//}
//
//static ULONG Overview_Cleanup(IClass  cl, Object * o, Msg msg)
//{
//  Overview_Data data = (Overview_Data ) INST_DATA(cl, o);
//  ColorMap cm = _screen(o).ViewPort.ColorMap;
//
...
//}
//
//static ULONG Overview_AskMinMax(IClass  cl, Object * o, MUIP_AskMinMax  msg)
//{
//  Overview_Data data = (Overview_Data ) INST_DATA(cl, o);
//  LONG scalex = data.ov_ScaleX;
//  LONG scaley = data.ov_ScaleY;
...
//}
//
//static ULONG Overview_Draw(IClass  cl, Object * o, MUIP_Draw  msg)
//{
//  Overview_Data data = (Overview_Data ) INST_DATA(cl, o);
//  RastPort rp = _rp(o);
//
...
//}
//
//static ULONG Overview_HandleInput(IClass  cl, Object * o, MUIP_HandleInput  msg)
//{
//  Overview_Data data = (Overview_Data ) INST_DATA(cl, o);
//  if (msg.imsg)
//  {
...
//}
//
//static ULONG Overview_Refresh(IClass  cl, Object * o)
//{
//  Overview_Data data = (Overview_Data ) INST_DATA(cl, o);
//  Overview_FillBuffer(data);
//  data.update = 2;
...
//}
//
//static ULONG Overview_RefreshSingle(IClass  cl, Object * o, MUIP_Overview_RefreshSingle  msg)
//{
//  Overview_Data data = (Overview_Data ) INST_DATA(cl, o);
//  LONG x, y;
//  LONG scalex = data.ov_ScaleX;
...
//  {
//  case OM_NEW:
//    return Overview_New(cl, obj, (opSet ) msg);
//  case OM_DISPOSE:
//    return Overview_Dispose(cl, obj, msg);
//  case OM_GET:
//    return Overview_Get(cl, obj, (opGet ) msg);
//  case OM_SET:
//    return Overview_Set(cl, obj, (opSet ) msg);
//  case MUIM_Setup:
//    return Overview_Setup(cl, obj, msg);
//  case MUIM_Cleanup:
//    return Overview_Cleanup(cl, obj, msg);
//  case MUIM_AskMinMax:
//    return Overview_AskMinMax(cl, obj, (MUIP_AskMinMax ) msg);
//  case MUIM_Draw:
//    return Overview_Draw(cl, obj, (MUIP_Draw ) msg);
//  case MUIM_HandleInput:
//    return Overview_HandleInput(cl, obj, (MUIP_HandleInput ) msg);
//  case MUIM_Overview_Refresh:
//    return Overview_Refresh(cl, obj);
//  case MUIM_Overview_RefreshSingle:
//    return Overview_RefreshSingle(cl, obj, (MUIP_Overview_RefreshSingle ) msg);
//  }
//  return (DoSuperMethodA(cl, obj, msg));
//}
//
//boolean create_overview_class()
//{
