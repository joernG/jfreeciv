...
//  Sprite vert_top, *vert_bottom, *vert_repeat, *vert_center;
//  Sprite hori_top, *hori_bottom, *hori_repeat, *hori_center;
//} config;
//
//static struct {
//  sw_widget window;
//  sw_widget chatline_vslider;
//  sw_widget chatline_hslider;
//  sw_widget chatline_list;
//} widgets;
//
///**************************************************************************
...
//  /* PORTME */
//#if 0
//  set_output_window_text("Cleared output window.");
//#endif
//}
//
///**************************************************************************
//  ...
//**************************************************************************/
//static void list_changed(sw_widget list, void *data)
//{
...
//  ...
//**************************************************************************/
//static void vscroll_buttons_callback(sw_widget button, void *data)
//{
//  int dx = (int) data;
...
//  ...
//**************************************************************************/
//static void hscroll_buttons_callback(sw_widget button, void *data)
//{
//  int dx = (int) data;
...
//}
//
//static void hslider_changed(sw_widget widget, void *data)
//{
...
//{
//  section_file file = te_open_themed_file("chatline.prop");
//
