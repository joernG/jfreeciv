...
//static int socklan;
//static server_list lan_servers;
...
//**************************************************************************/
//static void close_socket_nomessage(connection pc)
//{
...
//**************************************************************************/
//int connect_to_server(final String username, final String hostname, int port,
...
//**************************************************************************/
//int get_server_address(final String hostname, int port, char *errbuf,
//		       int errbufsize)
//{
//  if (port == 0)
...
//    () mystrlcpy(errbuf, "Failed looking up host.", errbufsize);
//    return -1;
//  }
//
//  return 0;
...
//     will be non-zero).
//**************************************************************************/
//int try_to_connect(final String username, char *errbuf, int errbufsize)
//{
...
//  if (aconnection.used) {
//    () mystrlcpy(errbuf, "Connection in progress.", errbufsize);
//    return -1;
//  }
//  
//  if ((aconnection.sock = socket(AF_INET, SOCK_STREAM, 0)) == -1) {
//    () mystrlcpy(errbuf, mystrerror(), errbufsize);
//    return -1;
//  }
//
...
//    client_kill_server(true);
//  }
//  append_output_window("Disconnected from server.");
//}  
//
///**************************************************************************
...
//**************************************************************************/
//static int read_from_connection(connection pc, boolean block)
//{
//  for (;;) {
//    fd_set readfs, writefs, exceptfs;
//    int socket_fd = pc.sock;
//    boolean have_data_for_server = (pc.used && pc.send_buffer
...
//**************************************************************************/
//static server_list parse_metaserver_data(fz_FILE *f)
//{
...
// longer used
//**************************************************************************/
//server_list create_server_list(char *errbuf, int n_errbuf)
//{
...
//    () mystrlcpy(errbuf, "Failed looking up host", n_errbuf);
//    return null;
//  }
//  
//  if((s = socket(AF_INET, SOCK_STREAM, 0)) == -1) {
//    () mystrlcpy(errbuf, mystrerror(), n_errbuf);
//    return null;
//  }
//  
//  if(connect(s, (sockaddr ) &addr.sockaddr, sizeof(addr)) == -1) {
//    () mystrlcpy(errbuf, mystrerror(), n_errbuf);
//    my_closesocket(s);
//    return null;
//  }
...
//    (unsigned long) (strlen("client_cap=") + capstr.length()),
//    capstr);
//
//  f = my_querysocket(s, str, str.length());
//
//  if (f == null) {
//    /* TRANS: This means a network error when trying to connect to
//     * the metaserver.  The message will be shown directly to the user. */
//    () mystrlcpy(errbuf, "Failed querying socket", n_errbuf);
//    return null;
//  }
//
//  /* skip HTTP headers */
...
//**************************************************************************/
//void delete_server_list(server_list server_list)
//{
