...
//*/
//
//static final String move_type_names[] = {
//  "Land", "Sea", "Heli", "Air"
//};
...
//  "GameLoss", "Diplomat"
//};
//static final String unit_class_names[] = {
//  "Air",
//  "Helicopter",
//  "Land",
//  "Missile",
...
//**************************************************************************/
//boolean unit_type_exists(Unit_Type_id id)
//{
...
//...
//**************************************************************************/
//unit_type unit_type(unit punit)
//{
...
//...
//**************************************************************************/
//boolean is_ground_unittype(Unit_Type_id id)
//{
...
//...
//**************************************************************************/
//boolean is_air_unittype(Unit_Type_id id)
//{
...
//...
//**************************************************************************/
//boolean is_heli_unittype(Unit_Type_id id)
//{
...
//...
//**************************************************************************/
//boolean is_water_unit(Unit_Type_id id)
//{
...
//...
//**************************************************************************/
//boolean unit_type_flag(Unit_Type_id id, int flag)
//{
...
//...
//**************************************************************************/
//boolean unit_flag(unit punit, enum unit_flag_id flag)
//{
...
//...
//**************************************************************************/
//boolean unit_has_role(Unit_Type_id id, int role)
//{
...
//**************************************************************************/
//final String unit_name(Unit_Type_id id)
//{
...
//**************************************************************************/
//final String unit_name_orig(Unit_Type_id id)
//{
...
//...
//**************************************************************************/
//final String get_unit_name(Unit_Type_id id)
//{
//  unit_type ptype;
...
//...
//**************************************************************************/
//int can_upgrade_unittype(player pplayer, Unit_Type_id id)
//{
...
//  belongs to.
//**************************************************************************/
//int unit_upgrade_price(const player const pplayer,
...
//**************************************************************************/
//Unit_Type_id find_unit_type_by_name(final String name)
//{
...
//  Returns U_LAST if none match.
//**************************************************************************/
//Unit_Type_id find_unit_type_by_name_orig(final String name_orig)
//{
...
//**************************************************************************/
//enum unit_flag_id unit_flag_from_str(final String s)
//{
//  enum unit_flag_id i;
//
...
//**************************************************************************/
//boolean can_player_build_unit_direct(player p, Unit_Type_id id)
//{
...
//**************************************************************************/
//boolean can_player_build_unit(player p, Unit_Type_id id)
//{  
...
//**************************************************************************/
//boolean can_player_eventually_build_unit(player p, Unit_Type_id id)
//{
//  if (!unit_type_exists(id)) {
//    return false;
//  }
...
//**************************************************************************/
//static void precalc_one(int i, boolean (*func_has)(Unit_Type_id, int))
//{
//  int j;
//
//  /* Count: */
...
//**************************************************************************/
//Unit_Type_id best_role_unit(city pcity, int role)
//{
//  Unit_Type_id u;
//  int j;
//  
...
//**************************************************************************/
//Unit_Type_id best_role_unit_for_player(player pplayer, int role)
//{
//  int j;
//
//  assert((role >= 0 && role < F_LAST) || (role >= L_FIRST && role < L_LAST));
...
//**************************************************************************/
//Unit_Type_id first_role_unit_for_player(player pplayer, int role)
//{
//  int j;
//
//  assert((role >= 0 && role < F_LAST) || (role >= L_FIRST && role < L_LAST));
