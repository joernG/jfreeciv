...
//  ...
//*************************************************************************/
//static sw_widget *get_item(sw_widget widget, int column,
//				   int row)
//{
//  sw_widget *result =
...
//  ...
//*************************************************************************/
//static void ensure_size(sw_widget widget, int column, int row)
//{
...
//      boolean *new_row_enabled = fc_malloc(sizeof(*new_row_enabled) * new_rows);
//
//      for (y = 0; y < new_rows; y++) {
...
//  ...
//*************************************************************************/
//static void layout(sw_widget widget)
//{
//  int x, y;
//
...
//      sw_widget w = *get_item(widget, x, y);
//
//      if (w) {
...
//  ...
//*************************************************************************/
//static void ensure_valid_layout(sw_widget widget)
//{
...
//  ...
//*************************************************************************/
//sw_widget sw_list_create(sw_widget parent, int pixel_width,
//				 int pixel_height)
//{
//  sw_widget result = create_widget(parent, WT_LIST);
//
//  result.draw = draw;
...
//  ...
//*************************************************************************/
//void sw_list_set_item(sw_widget widget, int column, int row,
//		      sw_widget item)
//{
...
//  ...
//*************************************************************************/
//void sw_list_get_offset(sw_widget widget, ct_point pos)
//{
...
//  ...
//*************************************************************************/
//void sw_list_get_view_size(sw_widget widget, ct_size size)
//{
...
//  ...
//*************************************************************************/
//void sw_list_get_window_size(sw_widget widget,ct_size size)
//{
//  sw_widget window = widget.data.list.window;
//
...
//  ...
//*************************************************************************/
//void sw_list_set_content_changed_notify(sw_widget widget,
...
//  ...
//*************************************************************************/
//void sw_list_set_selected_row(sw_widget widget, int row, boolean show)
//{
...
//  ...
//*************************************************************************/
//int sw_list_get_selected_row(sw_widget widget)
//{
...
//  ...
//*************************************************************************/
//void sw_list_set_row_enabled(sw_widget widget, int row, boolean enabled)
//{
//  ensure_size(widget, -1, row);
...
//  ...
//*************************************************************************/
//boolean sw_list_is_row_enabled(sw_widget widget, int row)
//{
...
//*************************************************************************/
//#if 0
//static void vslider_changed(sw_widget widget, void *data)
//{
...
//  ...
//*************************************************************************/
//static void list_changed(sw_widget widget, void *data)
//{
//    //printf("WIDGET_LIST\n");
...
//  ...
//*************************************************************************/
//static void vscroll_button_up_callback(sw_widget button, void *data)
//{
//  sw_widget vslider = data;
...
//  ...
//*************************************************************************/
//static void vscroll_button_down_callback(sw_widget button, void *data)
//{
//  sw_widget vslider = data;
//  float old = sw_slider_get_offset(vslider);
//  float width = sw_slider_get_width(vslider);
...
//  ...
//*************************************************************************/
//void sw_list_add_buttons_and_vslider(sw_widget widget,
...
//  ...
//*************************************************************************/
//void sw_list_set_selection_changed_notify(sw_widget widget,
//					  void (*callback) (struct sw_widget
//							    * widget,
//							    void *data),
//					  void *data)
...
//  ...
//*************************************************************************/
//void sw_list_clear(sw_widget widget)
//{
//  int x, y;
//
//  if (widget.data.list.columns == 0 && widget.data.list.rows == 0) {
