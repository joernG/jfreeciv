...
//#include "hash.h"
//
//public static final int FULL_RATIO = 0.75;         /* consider expanding when above this */
//public static final int MIN_RATIO = 0.24;          /* shrink when below this */
//
...
//  boolean frozen;			/* do not auto-resize when set */
//};
//
...
//**************************************************************************/
//static void zero_hbucket(hash_bucket bucket)
//{
...
//**************************************************************************/
//static void zero_htable(hash_table h)
//{
//  h.buckets = null;
//  h.fval = null;
//  h.fcmp = null;
...
//**************************************************************************/
//static void hash_free_contents(hash_table h)
//{
//  unsigned i;
//
//  for(i=0; i<h.num_buckets; i++) {
...
//  the old and assign.
//**************************************************************************/
//static void hash_resize_table(hash_table h, unsigned int new_nbuckets)
//{
//  hash_table h_new;
//  unsigned i;
//
...
//  
//  for(i=0; i<h.num_buckets; i++) {
//    hash_bucket bucket = &h.buckets[i];
//
...
//static void hash_maybe_resize(hash_table h, boolean expandingp)
//{
...
//**************************************************************************/
//void hash_delete_all_entries(hash_table h)
//{
...
//    hash_bucket bucket = &h.buckets[bucket_nr];
//
//    if (bucket.used != BUCKET_USED)
//      continue;
//
