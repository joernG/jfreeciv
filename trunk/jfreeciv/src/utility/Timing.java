...
//#else
//public static final int CLOCKS_PER_SEC = 1000000;	/* wild guess!! */
//#endif
//#endif
//
//public static final int N_USEC_PER_SEC = 1000000L;	  /* not 1000! :-) */
//
//enum timer_state {
//  TIMER_STARTED,
//  TIMER_STOPPED
...
//***********************************************************************/
//static void report_clock_failed(timer t)
//{
...
//  Ignore this timer from now on.
//***********************************************************************/
//static void report_gettimeofday_failed(timer t)
//{
//  static boolean first = true;
//
//  if (first) {
...
//  Ignore this timer from now on.
//***********************************************************************/
//static void report_time_failed(timer t)
//{
//  static boolean first = true;
//
//  if (first) {
...
//***********************************************************************/
//timer new_timer(enum timer_timetype type, enum timer_use use)
//{
...
//***********************************************************************/
//timer new_timer_start(enum timer_timetype type, enum timer_use use)
//{
...
//  }
//***********************************************************************/
//timer renew_timer(timer t, enum timer_timetype type,
//			  enum timer_use use)
//{
//  if (!t) {
//    t = (timer )fc_malloc(sizeof(struct timer));
//  }
//  t.type = type;
//  t.use = use;
//  clear_timer(t);
...
//***********************************************************************/
//timer renew_timer_start(timer t, enum timer_timetype type,
//				enum timer_use use)
//{
//  timer tt = renew_timer(t, type, use);
//  start_timer(tt);
//  return tt;
//}
//
...
//***********************************************************************/
//void clear_timer_start(timer t)
//{
//  clear_timer(t);
//  start_timer(t);
//}
...
//***********************************************************************/
//double read_timer_seconds(timer t)
//{
//  assert(t != null);
//  
//  if (t.use == TIMER_IGNORE) {
...
//***********************************************************************/
//void usleep_since_timer_start(timer t, long usec)
//{
//#ifdef HAVE_GETTIMEOFDAY
//  int ret;
...
//  {
//      timer t = new_timer_start(TIMER_USER, TIMER_ACTIVE);
//      ...do stuff...
//      usleep_since_timer_start_free(t, 15000);
//      ...continue...
//  }
//***********************************************************************/
//void usleep_since_timer_start_free(timer t, long usec)
//{
