...
//***********************************************************************/
//pqueue pq_create(int initial_size)
//{
...
//*********************************************************************/
//void pq_insert(pqueue q, pq_data_t datum, int datum_priority)
//{
//  int i;
//
//  assert(q != null);
...
//*******************************************************************/
//boolean pq_remove(pqueue  q, pq_data_t *dest)
//{
//  pq_data_t tmp;
//  int tmp_priority;
//  pq_data_t top;
...
//**********************************************************************/
//boolean pq_peek(pqueue q, pq_data_t * dest)
//{
//  assert(q != null);
//  if (q.size == 1) {
//    return false;
